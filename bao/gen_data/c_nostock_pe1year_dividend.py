...
if __name__ == "__main__":
    ...
    #选取沪深两市市值大、流动性好的 300 只股票，覆盖约 60% 的 A 股总市值
    zhishu_list.add("sh.000300", "沪深300-1")
    zhishu_list.add("sz.399300", "沪深300-2")
    #选取沪深两市剔除沪深 300 成分股及总市值排名前 300 的股票后，市值靠前的 500 只中小盘股
    zhishu_list.add("sh.000905", "中证500-1")
    zhishu_list.add("sz.399905", "中证500-2")
    #由沪深 300 和中证 500 成分股组成，共 800 只股票
    zhishu_list.add("sh.000906", "中证800-1")
    zhishu_list.add("sz.399906", "中证800-2")
